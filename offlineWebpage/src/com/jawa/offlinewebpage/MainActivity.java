package com.jawa.offlinewebpage;
...
public class MainActivity extends AppCompatActivity 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		myWebView.loadUrl("file:///android_asset/jawa/index.html");
	...
	public static class GitFragment extends Fragment 
	{
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) 
        {
           ...
           String gitNumber = getResources().getStringArray(R.array.GIT_ARRAY)[i];
           	...
           	if(gitNumber.equals("History"))
           	{
            WebView fragmentWebView = (WebView) rootView.findViewById(R.id.webview);
            WebSettings webSettings = fragmentWebView.getSettings();
            webSettings.setJavaScriptEnabled(true);
            fragmentWebView.loadUrl("file:///android_asset/jawa2/index.html");
           	}
           	else if(gitNumber.equals("Models"))
           	{
           		WebView fragmentWebView = (WebView) rootView.findViewById(R.id.webview);
                WebSettings webSettings = fragmentWebView.getSettings();
                webSettings.setJavaScriptEnabled(true);
                fragmentWebView.loadUrl("file:///android_asset/jawa3-models/index.html");
               		
           	}
           	else if(gitNumber.equals("Racing"))
           	{
           		WebView fragmentWebView = (WebView) rootView.findViewById(R.id.webview);
                WebSettings webSettings = fragmentWebView.getSettings();
                webSettings.setJavaScriptEnabled(true);
                fragmentWebView.loadUrl("file:///android_asset/jawa4-racing/jawa_racing.html");
               		
           	}
           	else if(gitNumber.equals("Jawa Today"))
           	{
           		WebView fragmentWebView = (WebView) rootView.findViewById(R.id.webview);
                WebSettings webSettings = fragmentWebView.getSettings();
                webSettings.setJavaScriptEnabled(true);
                fragmentWebView.loadUrl("file:///android_asset/jawa5-today/jawatoday.html");
               		
           	}
           	else if(gitNumber.equals("Classics–Jawa"))
           	{
           		WebView fragmentWebView = (WebView) rootView.findViewById(R.id.webview);
                WebSettings webSettings = fragmentWebView.getSettings();
                webSettings.setJavaScriptEnabled(true);
                fragmentWebView.loadUrl("file:///android_asset/jawa/index.html");
           	}
            return rootView;
        }
	}
